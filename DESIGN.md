...
- Persistent “仅存本机” status
- Map coordinates shown as blurred anonymous nodes
- Lock screen avoids exposing counts, names, or recent activity
- Backup controls explain local encryption in plain language
